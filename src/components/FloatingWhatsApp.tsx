    ...
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <div className="relative">
        <Button
          ...
          className="w-16 h-16 rounded-full bg-green-600 hover:bg-green-700 shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-110 group relative overflow-hidden"
        >
          <div className="absolute inset-0 bg-gradient-to-r from-green-600 to-green-500 rounded-full"></div>
          <MessageCircle className="h-8 w-8 text-white relative z-10 group-hover:animate-bounce" />
        ...
        {/* Tooltip */}
        {!isExpanded && (
          <div className="absolute right-full mr-4 top-1/2 -translate-y-1/2 bg-gray-800 text-white px-3 py-2 rounded-lg text-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
