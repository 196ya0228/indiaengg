            ...
            <div className="flex items-center gap-2 md:gap-4 lg:gap-6">
              <div className="flex items-center gap-2 bg-white/10 rounded-full px-2 md:px-3 py-1 backdrop-blur-sm">
                ...
                <span className="text-xs font-medium">
                  <span className="hidden sm:inline">{t('header.businessHours')}</span>
                  <span className="sm:hidden">{t('header.businessHoursShort')}</span>
                </span>
              </div>
              ...
              <div className="hidden sm:flex items-center gap-2 bg-white/10 rounded-full px-2 md:px-3 py-1 backdrop-blur-sm">
                ...
                <span className="text-xs font-medium">
                  <span className="hidden lg:inline">{t('header.manufacturingUnit')}</span>
                  <span className="hidden md:inline lg:hidden">{t('header.locationShort')}</span>
                  <span className="md:hidden">{t('header.locationMobile')}</span>
                </span>
              </div>
            ...
            <div className="flex items-center gap-2 md:gap-4">
              ...
              <div className="flex items-center gap-2 bg-gradient-to-r from-green-600/20 to-green-500/20 rounded-lg px-3 py-1 border border-green-500/30 backdrop-blur-sm">
                ...
                <span className="text-xs font-semibold text-green-300">
                  <span className="hidden md:inline">{t('header.gstReg')}: </span>09AABPI0229C1ZD
                </span>
              </div>
              ...
              <div className="flex items-center gap-1 bg-gradient-to-r from-orange-600/20 to-orange-500/20 rounded-lg px-2 py-1 border border-orange-500/30 backdrop-blur-sm">
                ...
                <span className="text-xs font-bold text-orange-300">
                  <span className="hidden sm:inline">{t('header.verifiedManufacturer')}</span>
                  <span className="sm:hidden">✓ {t('header.verified')}</span>
                </span>
              </div>
              ...
              <div className="md:hidden">
                <a href="tel:+919897601094" className="flex items-center gap-1 bg-white/10 rounded-full px-2 py-1 hover:bg-white/20 transition-all duration-300 backdrop-blur-sm">
                  ...
                  <span className="text-xs font-medium">{t('header.call')}</span>
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2 md:gap-4">
              ...
              <div className="md:hidden flex gap-1">
                ...
                >
                  <Phone className="h-3 w-3 text-green-400" />
                  <span className="text-xs font-semibold">{t('header.call1')}</span>
                </a>
                <a
                ...
                >
                  <Phone className="h-3 w-3 text-green-400" />
                  <span className="text-xs font-semibold">{t('header.call2')}</span>
                </a>
              </div>
              ...
              >
                ...
                <span className="hidden md:inline">{t('header.whatsappInquiry')}</span>
                <span className="md:hidden text-xs">{t('header.whatsapp')}</span>
              </Button>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white border-b-2 border-blue-100 shadow-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <div className="relative group">
                <button className="text-gray-700 hover:text-blue-600 transition-colors font-medium flex items-center gap-1 px-3 py-2 rounded-lg hover:bg-blue-50">
                  {t('navigation.products')} <span className="text-xs transition-transform group-hover:rotate-180">▼</span>
                </button>
            ...
            {/* Enhanced Search & Language Switcher */}
            <div className="flex items-center gap-2 md:gap-4">
              <div className="relative group">
                <div
                ...
                >
                  ...
                  <span className="text-sm text-gray-400 w-32 md:w-64 text-left">
                    <span className="hidden md:inline">{t('common.search')} Products, Machinery...</span>
              ...
              {/* Language Switcher */}
              <HeaderLanguageSwitcher className="border-2 border-gray-200 hover:border-blue-500" />
            </div>
          </div>
        </div>
      </div>
