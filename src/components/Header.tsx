        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-3 md:gap-4">
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-lg px-2 md:px-3 py-2">
              ...
              <Button 
                ...
                size="sm" 
                className="bg-green-600 text-white hover:bg-green-700 font-semibold px-4 py-2 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2"
              >
            ...
            <div className="flex items-center gap-4">
              <div className="relative group">
                <div
                  ...
                  className="flex items-center border-2 border-gray-200 rounded-xl px-4 py-2 bg-gray-50 hover:border-blue-500 hover:bg-white transition-all duration-300 shadow-sm hover:shadow-md cursor-pointer"
                >
                  <Search className="h-4 w-4 text-gray-400 mr-3 group-hover:text-blue-500 transition-colors" />
                  <span className="text-sm text-gray-400 w-64 text-left">
                    Search Products, Machinery...
                  </span>
                  <kbd className="ml-2 px-2 py-1 text-xs bg-gray-200 rounded text-gray-600">
                    Ctrl K
                  </kbd>
                </div>
              </div>
              <Button variant="outline" size="sm" className="md:hidden border-2 border-blue-200 hover:border-blue-500">
