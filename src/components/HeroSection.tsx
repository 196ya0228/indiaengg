          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                <div className="inline-block">
                  <Badge className="bg-white/20 text-white border-white/30 backdrop-blur-sm">
                    SUGAR PLANT & SPARE PARTS
                  </Badge>
                </div>

                <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                  <span className="text-white">SUGAR PLANT &</span>
                  <span className="block text-black font-extrabold text-5xl lg:text-7xl">SPARE PARTS</span>
                </h1>

                <h2 className="text-xl lg:text-2xl font-medium text-white mt-4">
                  WE DELIVER WHAT WE PROMISE
                </h2>

                <p className="text-xl lg:text-2xl opacity-90 leading-relaxed max-w-lg">
                  Specialized in Mini Sugar Plants, Jaggery Making Machines, Sugar Cane Crushers, Sugar Mill Gears, Gur Production Equipment, Khandsari Plant, Sugar Refinery Machinery, Jaggery Plant Setup
                </p>
                ...
                <div className="flex flex-wrap gap-4">
                  <Button
                    ...
                    size="lg"
                    className="bg-gradient-to-r from-orange-600 to-orange-500 text-white hover:from-orange-700 hover:to-orange-600 px-8 py-4 text-lg font-semibold shadow-xl industrial-glow relative overflow-hidden group"
                  >
                    <MechanicalGear size={20} color="currentColor" className="mr-2 group-hover:gear-rotate" />
                    Get Quote Now
                  </Button>
                  <Button
                    onClick={handleViewProducts}
                    size="lg"
                    className="btn-mechanical border-white text-white hover:bg-white hover:text-slate-800 px-8 py-4 text-lg font-semibold backdrop-blur-sm relative group"
                  >
            ...
            <div className="relative flex justify-center">
              <div className="relative">
                ...
                <div className="w-80 h-80 lg:w-96 lg:h-96 rounded-2xl bg-gradient-to-br from-slate-100 to-slate-200 border-4 border-slate-300 shadow-2xl flex items-center justify-center overflow-hidden relative card-mechanical">
                  ...
                  <img
                    ...
                    alt="Industrial Sugar Plant Machinery"
                ...
                {/* Company branding */}
                <div className="absolute bottom-4 right-4 bg-black/80 text-white px-3 py-1 rounded text-sm font-bold">
