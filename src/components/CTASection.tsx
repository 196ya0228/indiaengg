...
Looking forward to your quick response!`
  ...
  const handleWhatsAppContact = () => {
    trackWhatsAppClick('cta-whatsapp-card');
    sendWhatsAppInquiry('CTA WhatsApp Contact',
      `Hello India Engineering Works!

I saw your contact information and I'm interested in getting more details about your sugar plant machinery.
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8 md:mb-12">
            ...
            <button
              ...
              className="bg-white/10 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-white/20 hover:bg-white/15 transition-all duration-300 group w-full text-left cursor-pointer hover:scale-105 hover:shadow-xl active:scale-95"
            >
              ...
              <p className="text-sm text-blue-200 font-medium">+919837200396</p>
              <p className="text-xs text-green-200 mt-1 opacity-0 group-hover:opacity-100 transition-opacity">Click to start chat →</p>
            </button>

            {/* Phone Contact */}
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-white/20 hover:bg-white/15 transition-all duration-300 group hover:scale-105 hover:shadow-xl">
              <div className="flex items-center gap-3 mb-2">
              ...
              <div className="space-y-2">
                <button
                  onClick={() => handlePhoneContact('+919897601094')}
                  className="block text-sm text-blue-200 hover:text-white font-medium transition-colors hover:bg-white/10 rounded px-2 py-1 w-full text-left active:scale-95"
                >
                  📞 +919897601094
                </button>
                <button
                  onClick={() => handlePhoneContact('+919837200396')}
                  className="block text-sm text-blue-200 hover:text-white font-medium transition-colors hover:bg-white/10 rounded px-2 py-1 w-full text-left active:scale-95"
                >
                  📱 +919837200396
                </button>
              </div>
              <p className="text-xs text-blue-200 mt-2 opacity-0 group-hover:opacity-100 transition-opacity">Click to call →</p>
            </div>

            {/* Email Contact */}
            <button
              onClick={handleEmailContact}
              className="bg-white/10 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-white/20 hover:bg-white/15 transition-all duration-300 group sm:col-span-2 lg:col-span-1 w-full text-left cursor-pointer hover:scale-105 hover:shadow-xl active:scale-95"
            >
              <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-sm text-blue-200 hover:text-white transition-colors underline font-medium">
                📧 india_enggworks@yahoo.in
              </p>
              <p className="text-xs text-orange-200 mt-1 opacity-0 group-hover:opacity-100 transition-opacity">Click to send email →</p>
            </button>
          </div>
